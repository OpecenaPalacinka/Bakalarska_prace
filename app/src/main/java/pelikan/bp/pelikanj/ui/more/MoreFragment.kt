...
class MoreFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        val expand: ExpandableTextView = view.findViewById<ExpandableTextView?>(R.id.expand_text_view_about_us)
        expand.text = "\n" +
        ...
        val expands: ExpandableTextView = view.findViewById<ExpandableTextView?>(R.id.expand_text_view_become_translator)
        expands.text = "\n" +
